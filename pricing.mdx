...
Each request to the [Apply Endpoint](https://docs.redantai.com/api-reference/endpoint/apply) costs 1 credit. 1 credit costs 10 cents. If you buy larger bundles, you get a discount. You can buy credits by reaching out to [dada@redantai.com](mailto:dada@redantai.com).
